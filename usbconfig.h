 ...
 */
#define USB_CFG_VENDOR_NAME     'l','i','f','e','p','a','t','c','h','.','o','r','g'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'T', 'e', 'e', 'n', 'a', 'g', 'e', 'U', 'S', 'B'
 ...
 */
#define USB_CFG_INTERFACE_CLASS     0x01  /* HID */ /* define class here if not at device level */
#define USB_CFG_INTERFACE_SUBCLASS  0x03
